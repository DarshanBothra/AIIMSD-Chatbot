...
def getDemographics()->list:
    ...
    if age:
        ...
        print("Assistant: I couldn't extract your age, but that's okay.")
    ...
    if gender=="Unrecognized, Kindly type your gender":
        print("I couldn't recognize your gender, Kindly type it: ")
    ...
    for question in questions[1:]:
        ...
        if "frequent" in question:
            ...
            if scale:
                ...
                print("Assistant: Sorry I couldn't get that. Please type stating it in a different way.")
                second_inp: str = audioo()
                ...
                if second_scale:
                    ...
                    print(
                        "Assistant: Sorry I count' get that again. Please type it in: ")
                    data.append(input("Enter severity: "))
